...
#include "./wave8580__ST.cc"
#include "./wave8580_P_T.cc"
#include "./wave8580_PS_.cc"
#include "./wave8580_PST.cc"
...
{
  if (model == MOS6581) {
    wave__ST = (reg8*)&wave6581__ST[0];
    wave_P_T = (reg8*)&wave6581_P_T[0];
    wave_PS_ = (reg8*)&wave6581_PS_[0];
    wave_PST = (reg8*)&wave6581_PST[0];
  }
  else {
    wave__ST = (reg8*)&wave8580__ST[0];
    wave_P_T = (reg8*)&wave8580_P_T[0];
    wave_PS_ = (reg8*)&wave8580_PS_[0];
    wave_PST = (reg8*)&wave8580_PST[0];
  }
}
